...
process_file_header (FILE *f, word_t word)
{
  ...
  fprintf (list, "RIB name: %s", sixbit);
  ...
  fprintf (info, "Tape written: ");  //000077: 000127126723 
...
usage (const char *x)
{
  fprintf (stderr, "Usage: %s -t|-x [-f file]\n", x);
  exit (1);
}
